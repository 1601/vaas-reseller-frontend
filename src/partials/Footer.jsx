    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          {/* 1st block */}
          <div className="sm:col-span-12 lg:col-span-12 text-center">
            {/* <div className="mb-2">
                ...
                <div className="w-full">
                  ...
                  <div className="relative flex items-center max-w-xs">
                    ...
                    <button type="submit" className="absolute inset-0 left-auto" aria-label="Subscribe">
                      ...
                      <svg className="w-3 h-3 fill-current text-purple-600 mx-3 flex-shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">Made by <a className="text-purple-600 hover:underline" href="https://sparkles.com.ph/">SparkleStar International</a>. All rights reserved.</div>
