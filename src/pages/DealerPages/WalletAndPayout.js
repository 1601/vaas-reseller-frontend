  ...
  return (
    <>
      ...
      <Container maxWidth="md">
        ...
        <Card sx={{ mb: 5, p: 3 }}>
          <CardContent>
            <Typography variant="h5">Balance: {walletDetails.currency} {walletDetails.accountBalance}</Typography>
            ...
            >
              <Typography variant="body2" color="textSecondary"> Current Currency: {walletDetails.currency} {<EditIcon />}</Typography>
            </Box>
            {edit && (
              <Box width='30%'>
